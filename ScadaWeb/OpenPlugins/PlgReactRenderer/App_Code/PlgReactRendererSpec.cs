...
using Scada.Web.Plugins.ReactRenderer;
...
namespace Scada.Web.Plugins
{
    ...
    /// </summary>
    public class PlgReactRendererSpec : PluginSpec
    {
        /// <summary>
        ...
        public override string Descr
        {
            ...
            {
                return Localization.UseRussian ?
                    "Плагин обеспечивает отображение компонентов React." :
                    "The plugin provides react components rendering.";
            }
        }
        ...
        public override List<ViewSpec> ViewSpecs
        {
            get
            {
                return new List<ViewSpec>() { new ReactRendererViewSpec() };
            }
        }

        public override void OnUserLogin(UserData userData)
        {
            base.OnUserLogin(userData);
            ReactRenderer.ReactRendererUtils.OnStart();
        }
    }
}