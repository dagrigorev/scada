 ...
 */
  ...
  let validateEventDispatches = void 0
  {
 ...
 */
  ...
  const TOP_ANIMATION_END = unsafeCastStringToDOMTopLevelType(getVendorPrefixedEventName('animationend'))
  const TOP_ANIMATION_ITERATION = unsafeCastStringToDOMTopLevelType(getVendorPrefixedEventName('animationiteration'))
  const TOP_ANIMATION_START = unsafeCastStringToDOMTopLevelType(getVendorPrefixedEventName('animationstart'))
  const TOP_BLUR = unsafeCastStringToDOMTopLevelType('blur')
  const TOP_CAN_PLAY = unsafeCastStringToDOMTopLevelType('canplay')
  const TOP_CAN_PLAY_THROUGH = unsafeCastStringToDOMTopLevelType('canplaythrough')
  ...
  const TOP_COMPOSITION_END = unsafeCastStringToDOMTopLevelType('compositionend')
  const TOP_COMPOSITION_START = unsafeCastStringToDOMTopLevelType('compositionstart')
  const TOP_COMPOSITION_UPDATE = unsafeCastStringToDOMTopLevelType('compositionupdate')
  ...
  const TOP_DURATION_CHANGE = unsafeCastStringToDOMTopLevelType('durationchange')
  ...
  const TOP_GOT_POINTER_CAPTURE = unsafeCastStringToDOMTopLevelType('gotpointercapture')
  ...
  const TOP_LOADED_METADATA = unsafeCastStringToDOMTopLevelType('loadedmetadata')
  const TOP_LOST_POINTER_CAPTURE = unsafeCastStringToDOMTopLevelType('lostpointercapture')
  ...
  const TOP_SELECTION_CHANGE = unsafeCastStringToDOMTopLevelType('selectionchange')
  ...
  const TOP_TRANSITION_END = unsafeCastStringToDOMTopLevelType(getVendorPrefixedEventName('transitionend'))
 ...
 */
  ...
  let warning = warningWithoutStack$1
 ...
 */
  ...
  let ReactDebugCurrentFrame$1 = null
  ...
  const enableStableConcurrentModeAPIs = false

  const warnAboutShorthandPropertyCollision = false
 ...
 */
  ...
  function updateWrapper (element, props) {
    const node = element
    {
      const _controlled = isControlled(props)
  ...
  function postMountWrapper (element, props, isHydrating) {
    ...
    if (props.hasOwnProperty('value') || props.hasOwnProperty('defaultValue')) {
      ...
      const _initialValue = toString(node._wrapperState.initialValue)
  ...
  function createAndAccumulateChangeEvent (inst, nativeEvent, target) {
    const event = SyntheticEvent.getPooled(eventTypes$1.change, inst, nativeEvent, target)
    event.type = 'change'
 ...
 */
  const ChangeEventPlugin = {
    ...
    extractEvents: function (topLevelType, targetInst, nativeEvent, nativeEventTarget) {
      ...
      let getTargetInstFunc = void 0
      let handleEventFunc = void 0
 ...
 */
   ...
   */
    extractEvents: function (topLevelType, targetInst, nativeEvent, nativeEventTarget) {
      ...
      let eventInterface = void 0
      let leaveEventType = void 0
      let enterEventType = void 0
      let eventTypePrefix = void 0
 ...
 */
  ...
  const HostEffectMask = /*        */1023

  const Incomplete = /*            */1024
  const ShouldCapture = /*         */2048
  ...
  function isMounted (component) {
    {
      const owner = ReactCurrentOwner$1.current
 ...
 */
  ...
  const interactiveEventTypeNames = [[TOP_BLUR, 'blur'], [TOP_CANCEL, 'cancel'], [TOP_CLICK, 'click'], [TOP_CLOSE, 'close'], [TOP_CONTEXT_MENU, 'contextMenu'], [TOP_COPY, 'copy'], [TOP_CUT, 'cut'], [TOP_AUX_CLICK, 'auxClick'], [TOP_DOUBLE_CLICK, 'doubleClick'], [TOP_DRAG_END, 'dragEnd'], [TOP_DRAG_START, 'dragStart'], [TOP_DROP, 'drop'], [TOP_FOCUS, 'focus'], [TOP_INPUT, 'input'], [TOP_INVALID, 'invalid'], [TOP_KEY_DOWN, 'keyDown'], [TOP_KEY_PRESS, 'keyPress'], [TOP_KEY_UP, 'keyUp'], [TOP_MOUSE_DOWN, 'mouseDown'], [TOP_MOUSE_UP, 'mouseUp'], [TOP_PASTE, 'paste'], [TOP_PAUSE, 'pause'], [TOP_PLAY, 'play'], [TOP_POINTER_CANCEL, 'pointerCancel'], [TOP_POINTER_DOWN, 'pointerDown'], [TOP_POINTER_UP, 'pointerUp'], [TOP_RATE_CHANGE, 'rateChange'], [TOP_RESET, 'reset'], [TOP_SEEKED, 'seeked'], [TOP_SUBMIT, 'submit'], [TOP_TOUCH_CANCEL, 'touchCancel'], [TOP_TOUCH_END, 'touchEnd'], [TOP_TOUCH_START, 'touchStart'], [TOP_VOLUME_CHANGE, 'volumeChange']]
  const nonInteractiveEventTypeNames = [[TOP_ABORT, 'abort'], [TOP_ANIMATION_END, 'animationEnd'], [TOP_ANIMATION_ITERATION, 'animationIteration'], [TOP_ANIMATION_START, 'animationStart'], [TOP_CAN_PLAY, 'canPlay'], [TOP_CAN_PLAY_THROUGH, 'canPlayThrough'], [TOP_DRAG, 'drag'], [TOP_DRAG_ENTER, 'dragEnter'], [TOP_DRAG_EXIT, 'dragExit'], [TOP_DRAG_LEAVE, 'dragLeave'], [TOP_DRAG_OVER, 'dragOver'], [TOP_DURATION_CHANGE, 'durationChange'], [TOP_EMPTIED, 'emptied'], [TOP_ENCRYPTED, 'encrypted'], [TOP_ENDED, 'ended'], [TOP_ERROR, 'error'], [TOP_GOT_POINTER_CAPTURE, 'gotPointerCapture'], [TOP_LOAD, 'load'], [TOP_LOADED_DATA, 'loadedData'], [TOP_LOADED_METADATA, 'loadedMetadata'], [TOP_LOAD_START, 'loadStart'], [TOP_LOST_POINTER_CAPTURE, 'lostPointerCapture'], [TOP_MOUSE_MOVE, 'mouseMove'], [TOP_MOUSE_OUT, 'mouseOut'], [TOP_MOUSE_OVER, 'mouseOver'], [TOP_PLAYING, 'playing'], [TOP_POINTER_MOVE, 'pointerMove'], [TOP_POINTER_OUT, 'pointerOut'], [TOP_POINTER_OVER, 'pointerOver'], [TOP_PROGRESS, 'progress'], [TOP_SCROLL, 'scroll'], [TOP_SEEKING, 'seeking'], [TOP_STALLED, 'stalled'], [TOP_SUSPEND, 'suspend'], [TOP_TIME_UPDATE, 'timeUpdate'], [TOP_TOGGLE, 'toggle'], [TOP_TOUCH_MOVE, 'touchMove'], [TOP_TRANSITION_END, 'transitionEnd'], [TOP_WAITING, 'waiting'], [TOP_WHEEL, 'wheel']]

  const eventTypes$4 = {}
  const topLevelEventsToDispatchConfig = {}

  function addEventTypeNameToConfig (_ref, isInteractive) {
    const topEvent = _ref[0]
    const event = _ref[1]
  ...
  const knownHTMLTopLevelTypes = [TOP_ABORT, TOP_CANCEL, TOP_CAN_PLAY, TOP_CAN_PLAY_THROUGH, TOP_CLOSE, TOP_DURATION_CHANGE, TOP_EMPTIED, TOP_ENCRYPTED, TOP_ENDED, TOP_ERROR, TOP_INPUT, TOP_INVALID, TOP_LOAD, TOP_LOADED_DATA, TOP_LOADED_METADATA, TOP_LOAD_START, TOP_PAUSE, TOP_PLAY, TOP_PLAYING, TOP_PROGRESS, TOP_RATE_CHANGE, TOP_RESET, TOP_SEEKED, TOP_SEEKING, TOP_STALLED, TOP_SUBMIT, TOP_SUSPEND, TOP_TIME_UPDATE, TOP_TOGGLE, TOP_VOLUME_CHANGE, TOP_WAITING]
  ...
  const isInteractiveTopLevelEventType = SimpleEventPlugin.isInteractiveTopLevelEventType
 ...
 */
  ...
  // won't dispatch.
    ...
    if (!lastSelection || !shallowEqual(lastSelection, currentSelection)) {
      ...
      const syntheticEvent = SyntheticEvent.getPooled(eventTypes$3.select, activeElementInst$1, nativeEvent, nativeEventTarget)
 ...
 */
  ...
  function getHostProps$1 (element, props) {
    const hostProps = _assign({ children: undefined }, props)
  ...
  // TODO: direct imports like some-package/src/* are bad. Fix me.
  let didWarnValueDefaultValue$1 = void 0
 ...
 */
  ...
  let reusableSVGContainer = void 0
 ...
 */
  ...
  let warnedUnknownTags = void 0
  let suppressHydrationWarning = void 0

  let validatePropertiesInDevelopment = void 0
  let warnForTextDifference = void 0
  let warnForPropDifference = void 0
  let warnForExtraAttributes = void 0
  let warnForInvalidEventListener = void 0
  let canDiffStyleForHydrationWarning = void 0

  let normalizeMarkupForTextOrAttribute = void 0
  let normalizeHTML = void 0
  ...
  function diffHydratedProperties (domElement, tag, rawProps, parentNamespace, rootContainerElement) {
    let isCustomComponentTag = void 0
    let extraAttributeNames = void 0
  ...
  const unstable_cancelCallback = _ReactInternals$Sched.unstable_cancelCallback
  const unstable_now = _ReactInternals$Sched.unstable_now
  const unstable_scheduleCallback = _ReactInternals$Sched.unstable_scheduleCallback
  const unstable_shouldYield = _ReactInternals$Sched.unstable_shouldYield
  const unstable_getFirstCallbackNode = _ReactInternals$Sched.unstable_getFirstCallbackNode
  const unstable_continueExecution = _ReactInternals$Sched.unstable_continueExecution
  const unstable_pauseExecution = _ReactInternals$Sched.unstable_pauseExecution
  ...
  const cloneInstance = shim
  const createContainerChildSet = shim
  const appendChildToContainerChildSet = shim
  const finalizeContainerChildren = shim
  const replaceContainerChildren = shim
  const cloneHiddenInstance = shim
  const cloneUnhiddenInstance = shim
  const createHiddenTextInstance = shim

  let SUPPRESS_HYDRATION_WARNING = void 0
  {
  ...
  function getRootHostContext (rootContainerInstance) {
    ...
    }
    {
      ...
      const _ancestorInfo = updatedAncestorInfo(null, validatedTag)
  ...
  function getChildHostContext (parentHostContext, type, rootContainerInstance) {
    {
      ...
      const _namespace = getChildNamespace(parentHostContextDev.namespace, type)
      const _ancestorInfo2 = updatedAncestorInfo(parentHostContextDev.ancestorInfo, type)
  ...
  const noTimeout = -1
  const schedulePassiveEffects = unstable_scheduleCallback
  const cancelPassiveEffects = unstable_cancelCallback
  ...
  function stopWorkLoopTimer (interruptedBy, didCompleteRoot) {
    if (enableUserTimingAPI) {
      ...
      commitCountInCurrentWorkLoop = 0
      const label = didCompleteRoot ? '(React Tree Reconciliation: Completed Root)' : '(React Tree Reconciliation: Yielded)'
  ...
  let warnedAboutMissingGetChildContext = void 0
  ...
  const __interactionsRef = _ReactInternals$Sched$1.__interactionsRef
  const __subscriberRef = _ReactInternals$Sched$1.__subscriberRef
  const unstable_clear = _ReactInternals$Sched$1.unstable_clear
  const unstable_getCurrent = _ReactInternals$Sched$1.unstable_getCurrent
  const unstable_getThreadID = _ReactInternals$Sched$1.unstable_getThreadID
  const unstable_subscribe = _ReactInternals$Sched$1.unstable_subscribe
  const unstable_trace = _ReactInternals$Sched$1.unstable_trace
  const unstable_unsubscribe = _ReactInternals$Sched$1.unstable_unsubscribe
  const unstable_wrap = _ReactInternals$Sched$1.unstable_wrap
 ...
 */
  ...
  {
    const printWarning$1 = function (format) {
...

  {
    ...
    let pendingUnsafeLifecycleWarnings = new Map()
    ...
    ReactStrictModeWarnings.flushPendingUnsafeLifecycleWarnings = function () {
      pendingUnsafeLifecycleWarnings.forEach(function (lifecycleWarningsMap, strictRoot) {
        ...
        if (lifecyclesWarningMessages.length > 0) {
          const strictRootComponentStack = getStackByFiberInDevAndProd(strictRoot)
    ...
    ReactStrictModeWarnings.flushPendingDeprecationWarnings = function () {
      ...
      if (pendingComponentWillReceivePropsWarnings.length > 0) {
        ...
        const _sortedNames = setToSortedString(_uniqueNames)
      ...
      if (pendingComponentWillUpdateWarnings.length > 0) {
        const _uniqueNames2 = new Set()
        pendingComponentWillUpdateWarnings.forEach(function (fiber) {
          _uniqueNames2.add(getComponentName(fiber.type) || 'Component')
          didWarnAboutDeprecatedLifecycles.add(fiber.type)
        })

        const _sortedNames2 = setToSortedString(_uniqueNames2)
  ...
  const ReactFiberInstrumentation_1 = ReactFiberInstrumentation
  ...
  let didWarnAboutStateAssignmentForComponent = void 0
  let didWarnAboutUninitializedState = void 0
  let didWarnAboutGetSnapshotBeforeUpdateWithoutDidUpdate = void 0
  let didWarnAboutLegacyLifecyclesAndDerivedState = void 0
  let didWarnAboutUndefinedDerivedState = void 0
  let warnOnUndefinedDerivedState = void 0
  let warnOnInvalidCallback$1 = void 0
  let didWarnAboutDirectlyAssigningPropsToState = void 0
  let didWarnAboutContextTypeAndContextTypes = void 0
  let didWarnAboutInvalidateContextType = void 0
  ...
  let didWarnAboutMaps = void 0
  let didWarnAboutGenerators = void 0
  let didWarnAboutStringRefInStrictMode = void 0
  let ownerHasKeyUseWarning = void 0
  let ownerHasFunctionTypeWarning = void 0
  ...
  function ChildReconciler (shouldTrackSideEffects) {
    ...
    function placeChild (newFiber, lastPlacedIndex, newIndex) {
      ...
      const current$$1 = newFiber.alternate
      if (current$$1 !== null) {
        const oldIndex = current$$1.index
    ...
    function updateTextNode (returnFiber, current$$1, textContent, expirationTime) {
      ...
      // Update
        const existing = useFiber(current$$1, textContent, expirationTime)
    ...
    function updateElement (returnFiber, current$$1, element, expirationTime) {
      ...
      // Move based on index
        const existing = useFiber(current$$1, element.props, expirationTime)
    ...
    function updatePortal (returnFiber, current$$1, portal, expirationTime) {
      ...
      // Update
        const existing = useFiber(current$$1, portal.children || [], expirationTime)
        existing.return = returnFiber
        return existing
      }
    }
    ...
    function updateFragment (returnFiber, current$$1, fragment, expirationTime, key) {
      ...
      // Update
        const existing = useFiber(current$$1, fragment, expirationTime)
        existing.return = returnFiber
        return existing
      }
    }
    ...
    function createChild (returnFiber, newChild, expirationTime) {
      ...
      if (typeof newChild === 'object' && newChild !== null) {
        switch (newChild.$$typeof) {
          ...
          {
            const _created = createFiberFromElement(newChild, returnFiber.mode, expirationTime)
          ...
          case REACT_PORTAL_TYPE:
          {
            const _created2 = createFiberFromPortal(newChild, returnFiber.mode, expirationTime)
        ...
        if (isArray(newChild) || getIteratorFn(newChild)) {
          const _created3 = createFiberFromFragment(newChild, returnFiber.mode, expirationTime, null)
   ...
   */
    ...
    // add it later.
      ...
      // since the rest will all be insertions.
        for (; newIdx < newChildren.length; newIdx++) {
          const _newFiber = createChild(returnFiber, newChildren[newIdx], expirationTime)
          if (!_newFiber) {
            continue
          }
      ...
      for (; newIdx < newChildren.length; newIdx++) {
        const _newFiber2 = updateFromMap(existingChildren, returnFiber, newIdx, newChildren[newIdx], expirationTime)
        if (_newFiber2) {
          if (shouldTrackSideEffects) {
    ...
    // but using the iterator instead.
      ...
      // since the rest will all be insertions.
        for (; !step.done; newIdx++, step = newChildren.next()) {
          const _newFiber3 = createChild(returnFiber, step.value, expirationTime)
          if (_newFiber3 === null) {
            continue
          }
      ...
      // Keep scanning and use the map to restore deleted items as moves.
      for (; !step.done; newIdx++, step = newChildren.next()) {
        const _newFiber4 = updateFromMap(existingChildren, returnFiber, newIdx, step.value, expirationTime)
        if (_newFiber4 !== null) {
          if (shouldTrackSideEffects) {
    ...
    function reconcileSingleElement (returnFiber, currentFirstChild, element, expirationTime) {
      ...
      if (element.type === REACT_FRAGMENT_TYPE) {
        ...
        const _created4 = createFiberFromElement(element, returnFiber.mode, expirationTime)
  ...
  const NoEffect$1 = /*             */0
  const UnmountSnapshot = /*      */2
  const UnmountMutation = /*      */4
  const MountMutation = /*        */8
  const UnmountLayout = /*        */16
  const MountLayout = /*          */32
  const MountPassive = /*         */64
  const UnmountPassive = /*       */128

  const ReactCurrentDispatcher$1 = ReactSharedInternals.ReactCurrentDispatcher

  let didWarnAboutMismatchedHooksForComponent = void 0
  {
  ...
  function warnOnHookMismatchInDev () {
    {
      ...
      if (!didWarnAboutMismatchedHooksForComponent.has(componentName)) {
        ...
        let table = ''
        let prevHook = firstCurrentHook
        let nextHook = firstWorkInProgressHook
        let n = 1
  ...
  function updateReducer (reducer, initialArg, init) {
    ...
    // This is a re-render. Apply the new render phase updates to the previous
      const _dispatch = queue.dispatch
    ...
    if (first !== null) {
      ...
      let didSkip = false
      do {
        const updateExpirationTime = _update.expirationTime
  ...
  function pushEffect (tag, create, destroy, deps) {
    ...
    if (componentUpdateQueue === null) {
      ...
      const _lastEffect = componentUpdateQueue.lastEffect
      if (_lastEffect === null) {
        componentUpdateQueue.lastEffect = effect.next = effect
      } else {
        const firstEffect = _lastEffect.next
  ...
  function dispatchAction (fiber, queue, action) {
    ...
    // and apply the stashed updates on top of the work-in-progress hook.
      ...
      // Append the update to the end of the list.
      const _last = queue.last
      if (_last === null) {
      // This is the first update. Create a circular list.
        _update2.next = _update2
      } else {
        const first = _last.next
        if (first !== null) {
        // Still circular.
          _update2.next = first
        }
      ...
      // same as the current state, we may be able to bail out entirely.
        const _eagerReducer = queue.eagerReducer
        if (_eagerReducer !== null) {
          let prevDispatcher = void 0
          {
          ...
          try {
            ...
            const _eagerState = _eagerReducer(currentState, action)
  ...
  function stopProfilerTimerIfRunningAndRecordDelta (fiber, overrideBaseTime) {
    ...
    if (profilerStartTime >= 0) {
      const elapsedTime = unstable_now() - profilerStartTime
  ...
  let didWarnAboutBadClass = void 0
  let didWarnAboutContextTypeOnFunctionComponent = void 0
  let didWarnAboutGetDerivedStateOnFunctionComponent = void 0
  let didWarnAboutFunctionRefs = void 0
  let didWarnAboutReassigningProps = void 0
  ...
  function updateMemoComponent (current$$1, workInProgress, Component, nextProps, updateExpirationTime, renderExpirationTime) {
    ...
    Component.defaultProps === undefined) {
      ...
      const child = createFiberFromTypeAndProps(Component.type, null, nextProps, null, workInProgress.mode, renderExpirationTime)
    ...
    const currentChild = current$$1.child // This is always exactly one child
    if (updateExpirationTime < renderExpirationTime) {
  ...
  function updateSimpleMemoComponent (current$$1, workInProgress, Component, nextProps, updateExpirationTime, renderExpirationTime) {
    ...
    if (current$$1 !== null) {
      const prevProps = current$$1.memoizedProps
  ...
  function updateClassComponent (current$$1, workInProgress, Component, nextProps, renderExpirationTime) {
    ...
    const nextUnitOfWork = finishClassComponent(current$$1, workInProgress, Component, shouldUpdate, hasContext, renderExpirationTime)
    {
  ...
  function updateHostComponent (current$$1, workInProgress, renderExpirationTime) {
    ...
    const type = workInProgress.type
    const nextProps = workInProgress.pendingProps
    const prevProps = current$$1 !== null ? current$$1.memoizedProps : null
  ...
  function updateSuspenseComponent (current$$1, workInProgress, renderExpirationTime) {
    ...
    // ensure the state of the primary children is preserved.
      const prevState = current$$1.memoizedState
      const prevDidTimeout = prevState !== null
      if (prevDidTimeout) {
      // The current tree already timed out. That means each child set is
        const currentPrimaryChildFragment = current$$1.child
        ...
        // its fragment. We're going to skip over these entirely.
          ...
          const _primaryChildFragment = createWorkInProgress(currentPrimaryChildFragment, currentPrimaryChildFragment.pendingProps, NoWork)

          if ((workInProgress.mode & ConcurrentMode) === NoContext) {
          // Outside of concurrent mode, we commit the effects from the
            const _progressedState = workInProgress.memoizedState
            const _progressedPrimaryChild = _progressedState !== null ? workInProgress.child.child : workInProgress.child
          ...
          // treeBaseDuration is the sum of all the child tree base durations.
            ...
            let hiddenChild = _primaryChildFragment.child
          ...
          // working on.
          const _fallbackChildFragment = _primaryChildFragment.sibling = createWorkInProgress(currentFallbackChildFragment, _nextFallbackChildren, currentFallbackChildFragment.expirationTime)
        ...
        // and remove the intermediate fragment fiber.
          ...
          const primaryChild = reconcileChildFibers(workInProgress, currentPrimaryChild, _nextPrimaryChildren, renderExpirationTime)
      ...
      // children are not wrapped in a fragment fiber.
        const _currentPrimaryChild = current$$1.child
        if (nextDidTimeout) {
        // Timed out. Wrap the children in a fragment fiber to keep them
        // separate from the fallback children.
          const _nextFallbackChildren2 = nextProps.fallback
          const _primaryChildFragment2 = createFiberFromFragment(
          ...
          if ((workInProgress.mode & ConcurrentMode) === NoContext) {
          // Outside of concurrent mode, we commit the effects from the
            const _progressedState2 = workInProgress.memoizedState
            const _progressedPrimaryChild2 = _progressedState2 !== null ? workInProgress.child.child : workInProgress.child
          ...
          if (enableProfilerTimer && workInProgress.mode & ProfileMode) {
          // treeBaseDuration is the sum of all the child tree base durations.
            let _treeBaseDuration = 0
            let _hiddenChild = _primaryChildFragment2.child
          ...
          const _fallbackChildFragment2 = _primaryChildFragment2.sibling = createFiberFromFragment(_nextFallbackChildren2, mode, renderExpirationTime, null)
  ...
  function beginWork (current$$1, workInProgress, renderExpirationTime) {
    ...
    if (current$$1 !== null) {
      const oldProps = current$$1.memoizedProps
      const newProps = workInProgress.pendingProps
          ...
          case SuspenseComponent:
          {
            ...
            if (didTimeout) {
              ...
              if (primaryChildExpirationTime !== NoWork && primaryChildExpirationTime >= renderExpirationTime) {
                ...
                // priority. Bailout.
                const child = bailoutOnAlreadyFinishedWork(current$$1, workInProgress, renderExpirationTime)
                if (child !== null) {
    ...
    switch (workInProgress.tag) {
      ...
      case LazyComponent:
      {
        const _elementType = workInProgress.elementType
      ...
      case MemoComponent:
      {
        ...
        const _unresolvedProps3 = workInProgress.pendingProps
  ...
  function calculateChangedBits (context, newValue, oldValue) {
    ...
    // No change
      ...
      const changedBits = typeof context._calculateChangedBits === 'function' ? context._calculateChangedBits(oldValue, newValue) : maxSigned31BitInt
  ...
  function readContext (context, observedBits) {
    ...
    // Do not observe any updates.
      ...
      let resolvedObservedBits = void 0 // Avoid deopting on observable arguments or heterogeneous types.
  ...
  let didWarnUpdateInsideUpdate = void 0
  let currentlyProcessingQueue = void 0
  let resetCurrentlyProcessingQueue = void 0
  {
    ...
    switch (update.tag) {
      case ReplaceState:
      {
        ...
        if (typeof _payload === 'function') {
          ...
          const nextState = _payload.call(instance, prevState, nextProps)
          {
      ...
      case UpdateState:
      {
        const _payload2 = update.payload
  ...
  function processUpdateQueue (workInProgress, queue, props, instance, renderExpirationTime) {
    ...
    while (update !== null) {
      ...
      // a new result.
        ...
        const _callback = update.callback
        if (_callback !== null) {
    ...
    while (update !== null) {
      const _updateExpirationTime = update.expirationTime
      ...
      // a new result.
        resultState = getStateFromUpdate(workInProgress, queue, update, resultState, props, instance)
        const _callback2 = update.callback
        if (_callback2 !== null) {
          workInProgress.effectTag |= Callback
          // Set this to null, in case it was mutated during an aborted render.
          update.nextEffect = null
  ...
  function commitUpdateEffects (effect, instance) {
    while (effect !== null) {
      const _callback3 = effect.callback
      if (_callback3 !== null) {
  ...
  let appendAllChildren = void 0
  let updateHostContainer = void 0
  let updateHostComponent$1 = void 0
  let updateHostText$1 = void 0
  if (supportsMutation) {
  // Mutation mode
  ...
  function logCapturedError (capturedError) {
    ...
    {
      const componentName = capturedError.componentName
      const componentStack = capturedError.componentStack
      const errorBoundaryName = capturedError.errorBoundaryName
      const errorBoundaryFound = capturedError.errorBoundaryFound
      const willRetry = capturedError.willRetry
      ...
      let errorBoundaryMessage = void 0
  ...
  const callComponentWillUnmountWithTimer = function (current$$1, instance) {
      ...
      case ClassComponent:
      {
        ...
        if (finishedWork.effectTag & Update) {
          if (current$$1 === null) {
            ...
            const prevProps = finishedWork.elementType === finishedWork.type ? current$$1.memoizedProps : resolveDefaultProps(finishedWork.type, current$$1.memoizedProps)
            const prevState = current$$1.memoizedState
  ...
  function commitDetachRef (current$$1) {
    const currentRef = current$$1.ref
    if (currentRef !== null) {
  ...
  function commitUnmount (current$$1) {
    ...
    switch (current$$1.tag) {
      ...
      case SimpleMemoComponent:
      {
        const updateQueue = current$$1.updateQueue
        if (updateQueue !== null) {
      ...
      case ClassComponent:
      {
        ...
        const instance = current$$1.stateNode
  ...
  // itself will be GC:ed when the parent updates the next time.
    ...
    const alternate = current$$1.alternate
    if (alternate !== null) {
  ...
  function emptyPortalContainer (current$$1) {
    ...
    const portal = current$$1.stateNode
  ...
  function commitContainer (finishedWork) {
    ...
    switch (finishedWork.tag) {
      ...
      case HostPortal:
      {
        ...
        const _pendingChildren = portalOrRoot.pendingChildren
  ...
  // We only have the top Fiber that was deleted but we need recurse down its
    ...
    let currentParentIsContainer = void 0
    ...
    switch (finishedWork.tag) {
      ...
      case HostComponent:
      {
        ...
        if (instance != null) {
          ...
          // this case.
          const oldProps = current$$1 !== null ? current$$1.memoizedProps : newProps
          const type = finishedWork.type
      ...
      case HostText:
      {
        ...
        // as the newProps. The updatePayload will contain the real change in
        // this case.
        const oldText = current$$1 !== null ? current$$1.memoizedProps : newText
    ...
    // This is a thenable.
      ...
      do {
        if (_workInProgress.tag === SuspenseComponent) {
          const current$$1 = _workInProgress.alternate
          if (current$$1 !== null) {
            const currentState = current$$1.memoizedState
          ...
          const timeoutPropMs = _workInProgress.pendingProps.maxDuration
    ...
    do {
      switch (workInProgress.tag) {
        case HostRoot:
        {
          ...
          workInProgress.expirationTime = renderExpirationTime
          const _update = createRootErrorUpdate(workInProgress, _errorInfo, renderExpirationTime)
        ...
        // Capture and retry
          ...
          if ((workInProgress.effectTag & DidCapture) === NoEffect && (typeof ctor.getDerivedStateFromError === 'function' || instance !== null && typeof instance.componentDidCatch === 'function' && !isAlreadyFailedLegacyErrorBoundary(instance))) {
            ...
            const _update2 = createClassErrorUpdate(workInProgress, errorInfo, renderExpirationTime)
  ...
  function unwindWork (workInProgress, renderExpirationTime) {
    switch (workInProgress.tag) {
      ...
      case HostRoot:
      {
        popHostContainer(workInProgress)
        popTopLevelContextObject(workInProgress)
        const _effectTag = workInProgress.effectTag
      ...
      case SuspenseComponent:
      {
        const _effectTag2 = workInProgress.effectTag
  ...
  let didWarnAboutStateTransition = void 0
  let didWarnSetStateChildContext = void 0
  let warnAboutUpdateOnUnmounted = void 0
  let warnAboutInvalidUpdates = void 0
  ...
  let stashedWorkInProgressProperties = void 0
  let replayUnitOfWork = void 0
  let mayReplayFailedUnitOfWork = void 0
  let isReplayingFailedUnitOfWork = void 0
  let originalReplayError = void 0
  let rethrowOriginalError = void 0
  ...
  function commitRoot (root, finishedWork) {
    ...
    const earliestRemainingTimeBeforeCommit = childExpirationTimeBeforeCommit > updateExpirationTimeBeforeCommit ? childExpirationTimeBeforeCommit : updateExpirationTimeBeforeCommit
    ...
    const earliestRemainingTimeAfterCommit = childExpirationTimeAfterCommit > updateExpirationTimeAfterCommit ? childExpirationTimeAfterCommit : updateExpirationTimeAfterCommit
    ...
    if (enableSchedulerTracing) {
      ...
      try {
        ...
        if (subscriber !== null && root.memoizedInteractions.size > 0) {
          const threadID = computeThreadID(committedExpirationTime, root.interactionThreadID)
  ...
  function resetChildExpirationTime (workInProgress, renderTime) {
    ...
    // Let's use this same traversal to update the render durations.
      ...
      const shouldBubbleActualDurations = workInProgress.alternate === null || workInProgress.child !== workInProgress.alternate.child
      ...
      let _child = workInProgress.child
      while (_child !== null) {
  ...
  // parent fiber.
    ...
    // progress.
      const current$$1 = workInProgress.alternate
      {
  ...
  function renderRoot (root, isYieldy) {
    ...
    // There was an error
      ...
      // for a promise to resolve.
        ...
        root.didError = true
        const _suspendedExpirationTime = root.nextExpirationTimeToWorkOn = expirationTime
        const _rootExpirationTime = root.expirationTime = Sync
    ...
    // The tree was suspended.
      const _suspendedExpirationTime2 = expirationTime
      ...
      const _rootExpirationTime2 = root.expirationTime
  ...
  function captureCommitPhaseError (sourceFiber, value) {
    ...
    while (fiber !== null) {
      switch (fiber.tag) {
        ...
        case HostRoot:
        {
          const _errorInfo = createCapturedValue(value, sourceFiber)
          const _update = createRootErrorUpdate(fiber, _errorInfo, expirationTime)
    ...
    // itself should capture it.
      ...
      const _errorInfo2 = createCapturedValue(value, rootFiber)
      const _update2 = createRootErrorUpdate(rootFiber, _errorInfo2, expirationTime)
  ...
  const originalStartTimeMs = unstable_now()
  ...
  function recomputeCurrentRendererTime () {
    const currentTimeMs = unstable_now() - originalStartTimeMs
  ...
  function scheduleCallbackWithExpirationTime (root, expirationTime) {
    ...
    const currentMs = unstable_now() - originalStartTimeMs
  ...
  function performWorkOnRoot (root, expirationTime, isYieldy) {
    ...
    // Flush async work.
      let _finishedWork = root.finishedWork
      ...
      // This root is already complete. We can commit it.
        ...
        // If this root previously suspended, clear its existing timeout, since
        // we're about to try rendering again.
        const _timeoutHandle = root.timeoutHandle
  ...
  let didWarnAboutNestedUpdates = void 0
  let didWarnAboutFindNodeInStrictMode = void 0
  ...
  function updateContainer (element, container, parentComponent, callback) {
    const current$$1 = container.current
    const currentTime = requestCurrentTime()
    const expirationTime = computeExpirationForFiber(currentTime, current$$1)
  ...
  let topLevelUpdateWarnings = void 0
  let warnOnInvalidCallback = void 0
 ...
 */
    ...
    unmountComponentAtNode: function (container) {
      ...
      if (container._reactRootContainer) {
      ...
      } else {
        {
          ...
          const hasNonRootReactChild = !!(_rootEl && getInstanceFromNode$1(_rootEl))
  ...
  const ReactDOM$2 = Object.freeze({
    default: ReactDOM
  })

  const ReactDOM$3 = (ReactDOM$2 && ReactDOM) || ReactDOM$2

  // TODO: decide on the top-level export form.
  // This is hacky but makes it work with both Rollup and Jest.
  const reactDom = ReactDOM$3.default || ReactDOM$3
