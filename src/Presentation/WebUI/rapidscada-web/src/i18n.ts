...
const en = {
  translation: {
    ...
    discovery: {
      ...
      subtitle: 'Monitor and manage microservice architecture',
      services: 'Services',
...
const ru = {
  translation: {
    ...
    discovery: {
      ...
      subtitle: 'Мониторинг и управление микросервисной архитектурой',
      services: 'Сервисы',
      ...
      noAuth: 'Публичный доступ',
      overallStatus: 'Общее состояние',
      lastChecked: 'Последняя проверка',
      status: 'Статус',
      responseTime: 'Время отклика',
      message: 'Сообщение',
      totalEndpoints: 'Всего точек',
      filterByService: 'Фильтр по сервису',
      service: 'Сервис',
      method: 'Метод',
      path: 'Путь',
      auth: 'Аутентификация',
